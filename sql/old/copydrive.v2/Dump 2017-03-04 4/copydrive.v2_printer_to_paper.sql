...
CREATE TABLE `printer_to_paper` (
  ...
  CONSTRAINT `fk_ptp_print` FOREIGN KEY (`IdPrinter`) REFERENCES `printer` (`id_printer`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2017-03-04 21:14:42
