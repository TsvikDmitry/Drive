SELECT ppp.id_paper_price, prt.name_printer, f.id_format, 
...
inner join paper pap on pap.id_paper=pp.id_paper  where f.id_format=1 and prt.id_printer=1 and pp.id_paper=1 ;