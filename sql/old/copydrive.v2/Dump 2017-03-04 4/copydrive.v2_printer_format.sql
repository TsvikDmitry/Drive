...
CREATE TABLE `printer_format` (
  ...
  CONSTRAINT `Fk_pf_print` FOREIGN KEY (`idPrinter`) REFERENCES `printer` (`id_printer`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2017-03-04 21:14:40
