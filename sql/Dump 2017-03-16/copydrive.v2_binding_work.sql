...
CREATE TABLE `binding_work` (
  ...
  KEY `fk_binding_work_format_idx` (`id_binding_format`),
  CONSTRAINT `fk_binding_work_format` FOREIGN KEY (`id_binding_format`) REFERENCES `binding_format` (`id_binding_format`)
