...
CREATE TABLE `binding_spring_size` (
  `id_binding_spring_size` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id_binding_spring_size`),
  KEY `fk_spring_idx` (`id_binding_spring`),
  CONSTRAINT `fk_spring` FOREIGN KEY (`id_binding_spring`) REFERENCES `binding_spring` (`id_binding_spring`)
