...
/**********************************Format************************************************/
    public void BindingFormat() {
        ...
        FormatTable.setRowFactory( tv -> {
            TableRow<BindingFormat> row = new TableRow<>();
    ...
    public void BindingFormatUpdata()  {
        ...
        try {
            lazData = BindingFormatDB.select();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void CoverUpdata() {
        ...
        try {
            lazData = BindingCoverDB.select(getIdFormat());
        } catch (Exception e) {
    ...
    public void SpringUpdata() {
        ...
        try {
            ...
            lazData = BindingSpringSizeDB.selectSpring();
    ...
    public void SpringSizeUpdata() {
        ...
        try {
            ...
            lazData = BindingSpringSizeDB.selectSpringSize(getIdSpring());
