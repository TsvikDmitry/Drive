...
CREATE TABLE `order_printer` (
  ...
  CONSTRAINT `fk_ord_paper` FOREIGN KEY (`id_paper`) REFERENCES `paper` (`idPrinter`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `order_printer` VALUES (57,111,'Лазерный ЧБ (A4, 4+0, Офсет, 80)',2,1,1,1,1,1.1,0.2,'80',1,1.3,1.3,1),(58,111,'HP 4250 (A4, 4+0, Офсет, 80)',3,1,1,1,1,1.1,0.2,'80',1,1.3,1.3,1),(59,111,'Лазерный Цвет',1,1,1,1,1,4.25,0.2,'80',1,4.45,4.45,1),(60,111,'Лазерный ЧБ',2,1,1,7,4,55,0,'0',333,55,18315,333),(61,111,'HP 4250',3,1,1,1,1,0.4,0.2,'80',1,0.6,0.6,1),(62,111,'Лазерный Цвет',1,1,1,1,1,4.25,0.6,'200',1,4.85,4.85,1);
