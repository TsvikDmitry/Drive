...
public class PrinterDB {
    ...
    public static ObservableList<Printer> selectPrint() throws Exception {
        ...
        String selectStmt = "SELECT * FROM printer  where visible=true";
    ...
    public static ObservableList<Printer> selectCheckCount() throws Exception {

        String selectStmt = "SELECT * FROM printer where check_count=true and visible=true";
    ...
    private static ObservableList<Printer> getPrinterResultSet(ResultSet result) throws SQLException
    {
        ...
        while (result.next()) {
            ...
            printer.setIdPrinter(result.getInt("id_printer"));
            ...
            printer.setCheckCount(result.getBoolean("check_count"));
