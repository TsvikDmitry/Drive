...
CREATE TABLE `order_plotter` (
  ...
  `area_paper` decimal(10,2) DEFAULT NULL,
...
INSERT INTO `order_plotter` VALUES (3,223,2,NULL,1,1,222,222,1,180,100,NULL,0.33,105.00,25.00,25.00,25.00,33.00,10.00,33.00,10.00);
